package com.bookexample.controller;
...
import com.bookexample.service.BooksServiceImpl;
...
public class BooksController {
	...
	public String deleteBooks(@PathVariable (value = "id") long bookId) {
		
		// call delete employee method 
		this.booksService.deleteBooksById(bookId);
		return "redirect:/";
	}
